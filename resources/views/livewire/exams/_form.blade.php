...
<div class="mb-4">
    <label class="block text-gray-700 text-sm font-bold mb-2">Exam Date</label>
    <input type="date" wire:model="exam_date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
</div>
